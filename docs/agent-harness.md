...
| Actual-grid lock / legacy guard | `docs/actual-lock-guardrails.md`, `core/actual-grid-core.js`, `core/timesheet-state-core.js`, `ui/time-entry-renderer.js`, `controllers/time-entry-render-controller.js` | `npm run test:actual-lock` | `npm test`; browser smoke from `docs/actual-lock-guardrails.md` |
...
| Timer | `controllers/timer-controller.js`, `core/plan-segment-timer-core.js`, `ui/time-control-renderer.js` | `node --test __tests__/timer-controller.test.js __tests__/plan-segment-timer-core.test.js __tests__/time-control-renderer.test.js` | `npm test`; browser smoke if controls or rendered state change |
...
| Harness docs / validation | `docs/agent-harness.md`, `docs/harness-quality-score.md`, `docs/docs-index.md`, `scripts/validate-agent-harness.mjs`, `__tests__/agent-harness-docs.test.js`, `AGENTS.md`, `README.md`, `package.json` | `npm run test:harness` | `npm test` |
