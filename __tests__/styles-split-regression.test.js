...
test('split css files exist and keep section anchors', () => {
    ...
    assert.match(interactionsSource, /\.plan-segment-resize-handle\s*\{[^}]*top:\s*50%;[^}]*width:\s*28px;[^}]*height:\s*min\(66%,\s*56px\);[^}]*opacity:\s*1;[^}]*--plan-segment-handle-color:\s*var\(--split-segment-color,\s*rgba\(223,\s*228,\s*234,\s*0\.85\)\);/s);
    assert.match(interactionsSource, /\.plan-segment-resize-handle-right\s*\{[^}]*right:\s*5px;/s);
    assert.match(interactionsSource, /\.plan-segment-resize-handle-right\.plan-segment-boundary-resize-handle-shared\s*\{[^}]*right:\s*-14px;/s);
    ...
    assert.match(interactionsSource, /\.plan-segment-boundary-resize-handle-line,\s*\.plan-segment-resize-handle::after\s*\{[^}]*width:\s*18px;[^}]*border:\s*2px solid rgba\(15,\s*23,\s*42,\s*0\.95\);[^}]*box-shadow:/s);
    assert.match(interactionsSource, /\.plan-segment-boundary-resize-handle-line::after\s*\{[^}]*width:\s*6px;[^}]*border:\s*1px solid rgba\(15,\s*23,\s*42,\s*0\.9\);/s);
    ...
    assert.match(responsiveSource, /@media \(max-width:\s*768px\), \(hover:\s*none\), \(pointer:\s*coarse\)\s*\{[\s\S]*?\.plan-segment-resize-handle-right\s*\{[^}]*right:\s*3px;/s);
    ...
    assert.match(responsiveSource, /@media \(max-width:\s*768px\), \(hover:\s*none\), \(pointer:\s*coarse\)\s*\{[\s\S]*?\.plan-segment-boundary-resize-handle-line,\s*\.plan-segment-resize-handle::after\s*\{[^}]*width:\s*18px;/s);
