...
test('split css files exist and keep section anchors', () => {
    ...
    assert.doesNotMatch(interactionsSource, /plan-segment-resize-preview-layer|plan-segment-resize-preview-segment|plan-segment-resize-preview-rest|plan-segment-resize-preview-label|plan-segment-resize-preview-duration/);
    assert.doesNotMatch(interactionsSource, /\.split-grid\.is-previewing-plan-resize/);
